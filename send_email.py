...
<title>The New Yorker Daily</title>
<style>
...
.header::after{content:'';position:absolute;bottom:-20px;left:0;right:0;height:20px;background:linear-gradient(to bottom right,#16213e 0%,#16213e 50%,transparent 50%)}
.hi{display:flex;align-items:center;justify-content:space-between}
.hi h1{font-size:22px;font-weight:700;color:#fff}
.hi .sub{font-size:14px;opacity:0.75;margin-top:4px;color:#c0c0c0}
.db{background:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.25);border-radius:20px;padding:6px 16px;font-size:13px;text-align:center}
.db span{display:block;font-size:11px;opacity:0.65;margin-bottom:2px}
...
.art h2{font-size:17px;font-weight:600;color:#1a1a2e;line-height:1.5;margin-bottom:12px;padding-left:14px;border-left:4px solid #1a1a2e}
...
.art strong{color:#1a1a2e;font-weight:600}
